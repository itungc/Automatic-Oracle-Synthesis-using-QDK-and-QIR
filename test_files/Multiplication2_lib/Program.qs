...
namespace Microsoft.Quantum.OracleGenerator {
    ...
    operation Multiplication2(inputs : (Qubit[], Qubit[]), output : Qubit[]) : Unit {
    ...
    operation RunProgram() : Unit {
        InitOracleGeneratorFor(Microsoft.Quantum.OracleGenerator.Classical.Multiplication2);
        ...
        ApplyXorInPlace(2, LittleEndian(b));

        MultiplyI(LittleEndian(a), LittleEndian(b), LittleEndian(f));
...
// Test case 1: return (a or b) and (a or c) and (b or c);
// Test case 2: return (a and b) and (a or c) and (b or c);
// Test case 3: return (a and b) and (a or c) and (b and c);
// Test case 4: return (a + b) + (a + c) + (b + c);