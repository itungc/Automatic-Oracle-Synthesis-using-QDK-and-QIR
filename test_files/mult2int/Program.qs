...
namespace Microsoft.Quantum.OracleGenerator {
    ...
    operation Multiply2Int(inputs : (Qubit[], Qubit[]), output : Qubit[]) : Unit {
        // The implementation of this operation will be
        // automatically derived from the description in
        // OracleGenerator.Classical.Multiply2Int.
    }

    @EntryPoint()
    operation RunProgram() : Unit {
        InitOracleGeneratorFor(Microsoft.Quantum.OracleGenerator.Classical.Multiply2Int);
...
namespace Microsoft.Quantum.OracleGenerator.Classical {
    ...
    // the empty Multiply2Int operation automatically.  Note that the input type
    ...
    internal function Multiply2Int(a : Int, b : Int) : Int {
        return (a * b);
    }
}