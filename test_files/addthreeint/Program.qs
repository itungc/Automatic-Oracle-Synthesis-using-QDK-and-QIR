...
namespace Microsoft.Quantum.OracleGenerator {
    ...
    operation addthreeint(inputs : (Qubit[], Qubit[], Qubit[]), output : Qubit[]) : Unit {
    ...
    operation RunProgram() : Unit {
        InitOracleGeneratorFor(Microsoft.Quantum.OracleGenerator.Classical.addthreeint);
...
namespace Microsoft.Quantum.OracleGenerator.Classical {
    ...
    internal function addthreeint(a : Int, b : Int, c: Int) : Int {
        return (a + b + c);
    }
}