...
namespace Microsoft.Quantum.OracleGenerator {
    ...
    operation srem(inputs : (Qubit[], Qubit[], Qubit[]), output : Qubit) : Unit {
    ...
    operation RunProgram() : Unit {
        InitOracleGeneratorFor(Microsoft.Quantum.OracleGenerator.Classical.srem);
...
namespace Microsoft.Quantum.OracleGenerator.Classical {
    ...
    internal function srem(a : Int, b : Int, x: Int) : Bool {
        // (a + b*x ) mod N --- (a + (b*x) mod N) mod N == (a + (b*x))
        return ((a + ((b*x)%11))%11)==0;
    }   
}