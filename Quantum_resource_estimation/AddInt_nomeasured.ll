...
@0 = internal constant [5 x i8] c"Done\00"
...
@1 = internal constant [33 x i8] c"`bits` must be between 0 and 63 \00"
@2 = internal constant [34 x i8] c"`number` must be between 0 and 2^\00"
@3 = internal constant [15 x i8] c" - 1, but was \00"
...
@Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__FunctionTable = internal constant [4 x void (%Tuple*, %Tuple*, %Tuple*)*] [void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__body__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__adj__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctl__wrapper, void (%Tuple*, %Tuple*, %Tuple*)* @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctladj__wrapper]
...
entry:
  ...
  call void @Microsoft__Quantum__OracleGenerator___8a274f65634140809d2b2b154d554b32_InitOracleGeneratorFor__body(%Callable* %0)
  ...
  %7 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  call void @__quantum__rt__message(%String* %7)
  %8 = getelementptr inbounds { %Array* }, { %Array* }* %1, i32 0, i32 0
  %9 = load %Array*, %Array** %8, align 8
  %10 = getelementptr inbounds { %Array* }, { %Array* }* %2, i32 0, i32 0
  %11 = load %Array*, %Array** %10, align 8
  call void @__quantum__rt__array_update_alias_count(%Array* %c, i32 -1)
  call void @__quantum__rt__array_update_reference_count(%Array* %9, i32 -1)
  %12 = bitcast { %Array* }* %1 to %Tuple*
...
define internal void @Microsoft__Quantum__OracleGenerator___8a274f65634140809d2b2b154d554b32_InitOracleGeneratorFor__body(%Callable* %func) {
entry:
...
entry:
  ...
  %4 = call %Callable* @Microsoft__Quantum__Canon___2437c93c6f0e440ab943b959ebedf1de_CControlledCA__body(%Callable* %3)
  ...
  %7 = call %Array* @Microsoft__Quantum__Arrays___8f20b007c90340e28055b9b4742e10e2_Zipped__body(%Array* %6, %Array* %1)
  call void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__body(%Callable* %4, %Array* %7)
  call void @__quantum__rt__array_update_alias_count(%Array* %1, i32 -1)
  call void @__quantum__rt__tuple_update_alias_count(%Tuple* %2, i32 -1)
...
condContinue__1:                                  ; preds = %condTrue__1, %entry
  ...
  %6 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @1, i32 0, i32 0))
...
condContinue__3:                                  ; preds = %condTrue__3, %condContinue__2
  ...
  %14 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @2, i32 0, i32 0))
  ...
  %17 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @3, i32 0, i32 0))
  ...
  %21 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @4, i32 0, i32 0))
...
define internal %Callable* @Microsoft__Quantum__Canon___2437c93c6f0e440ab943b959ebedf1de_CControlledCA__body(%Callable* %op) {
entry:
  ...
  %0 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
...
define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__body__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  ...
  %6 = load %Qubit*, %Qubit** %3, align 8
  call void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__body(i1 %4, %Callable* %5, %Qubit* %6)
  ret void
}

define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__adj__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  %0 = bitcast %Tuple* %arg-tuple to { i1, %Callable*, %Qubit* }*
  %1 = getelementptr inbounds { i1, %Callable*, %Qubit* }, { i1, %Callable*, %Qubit* }* %0, i32 0, i32 0
  %2 = getelementptr inbounds { i1, %Callable*, %Qubit* }, { i1, %Callable*, %Qubit* }* %0, i32 0, i32 1
  ...
  %5 = load %Callable*, %Callable** %2, align 8
  %6 = load %Qubit*, %Qubit** %3, align 8
  call void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__adj(i1 %4, %Callable* %5, %Qubit* %6)
  ret void
}

define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctl__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  ...
  call void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctl(%Array* %3, { i1, %Callable*, %Qubit* }* %4)
  ret void
}

define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctladj__wrapper(%Tuple* %capture-tuple, %Tuple* %arg-tuple, %Tuple* %result-tuple) {
entry:
  %0 = bitcast %Tuple* %arg-tuple to { %Array*, { i1, %Callable*, %Qubit* }* }*
  %1 = getelementptr inbounds { %Array*, { i1, %Callable*, %Qubit* }* }, { %Array*, { i1, %Callable*, %Qubit* }* }* %0, i32 0, i32 0
  %2 = getelementptr inbounds { %Array*, { i1, %Callable*, %Qubit* }* }, { %Array*, { i1, %Callable*, %Qubit* }* }* %0, i32 0, i32 1
  %3 = load %Array*, %Array** %1, align 8
  %4 = load { i1, %Callable*, %Qubit* }*, { i1, %Callable*, %Qubit* }** %2, align 8
  call void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctladj(%Array* %3, { i1, %Callable*, %Qubit* }* %4)
  ret void
}
...
define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__body(i1 %bit, %Callable* %op, %Qubit* %target) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__adj(i1 %bit, %Callable* %op, %Qubit* %target) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  br i1 %bit, label %then0__1, label %continue__1
...
define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctl(%Array* %__controlQubits__, { i1, %Callable*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { i1, %Callable*, %Qubit* }, { i1, %Callable*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Canon___6447343266f84ef39ed7241574bb6b2f_ApplyIfCA__ctladj(%Array* %__controlQubits__, { i1, %Callable*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { i1, %Callable*, %Qubit* }, { i1, %Callable*, %Qubit* }* %0, i32 0, i32 0
  %bit = load i1, i1* %1, align 1
...
define internal void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  %9 = call %Range @Microsoft__Quantum__Arrays___b5f9969abbdb494a9072f27aced6dfdb_IndexRange__body(%Array* %register)
...
define internal %Range @Microsoft__Quantum__Arrays___b5f9969abbdb494a9072f27aced6dfdb_IndexRange__body(%Array* %array) {
entry:
...
define internal void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  %0 = call i64 @__quantum__rt__array_get_size_1d(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
...
exit__1:                                          ; preds = %header__1
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
  %12 = call %Range @Microsoft__Quantum__Arrays___b5f9969abbdb494a9072f27aced6dfdb_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { %Callable*, %Array* }, { %Callable*, %Array* }* %0, i32 0, i32 0
  %singleElementOperation = load %Callable*, %Callable** %1, align 8
...
define internal %Array* @Microsoft__Quantum__Arrays___8f20b007c90340e28055b9b4742e10e2_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
entry:
  ...
  %6 = call %Array* @Microsoft__Quantum__Convert__IntAsBoolArray__body(i64 %value, i64 %5)
  %7 = call %Array* @Microsoft__Quantum__Arrays___8f20b007c90340e28055b9b4742e10e2_Zipped__body(%Array* %6, %Array* %1)
  call void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__adj(%Callable* %4, %Array* %7)
  call void @__quantum__rt__array_update_alias_count(%Array* %1, i32 -1)
  call void @__quantum__rt__tuple_update_alias_count(%Tuple* %2, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %3, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %3, i32 -1)
...
entry:
  ...
  %7 = call %Callable* @Microsoft__Quantum__Canon___2437c93c6f0e440ab943b959ebedf1de_CControlledCA__body(%Callable* %6)
  ...
  %10 = call %Array* @Microsoft__Quantum__Arrays___8f20b007c90340e28055b9b4742e10e2_Zipped__body(%Array* %9, %Array* %4)
  call void @__quantum__rt__array_update_reference_count(%Array* %9, i32 -1)
  ...
  call void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %12)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %4, i32 -1)
  call void @__quantum__rt__tuple_update_alias_count(%Tuple* %5, i32 -1)
...
entry:
  ...
  store %Callable* %7, %Callable** %13, align 8
  store %Array* %10, %Array** %14, align 8
  call void @Microsoft__Quantum__Canon___dbe67f7560fb47f4a6836363bf5d4e9c_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %12)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %4, i32 -1)
  call void @__quantum__rt__tuple_update_alias_count(%Tuple* %5, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %7, i32 -1)
