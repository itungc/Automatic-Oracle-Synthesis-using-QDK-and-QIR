...
std::unordered_map<llvm::Function*, llvm::Function*> find_function_pairs(llvm::Module& module)
{
    ...
    // in our sample the operation `Microsoft.Quantum.OracleGenerator.mult2int3`
    // corresponds to the fuction
    // `Microsoft.Quantum.OracleGenerator.Classical.mult2int3`.  If we find such
...
int main(int argc, char** argv)
{
    ...
    for (auto [func, op] : pairs)
    {
        ...
        write_verilog(xag, "/home/professorchaman/EE522-Team_3-Project/verilog_reader/mult2int/xag.v");

        const auto opt = optimize(xag);
        write_verilog(opt, "/home/professorchaman/EE522-Team_3-Project/verilog_reader/mult2int/opt.v");
